#ifndef GAMESERVER_QUERY_CLIENT_H
#define GAMESERVER_QUERY_CLIENT_H
...
struct QueryClient {
	QueryClient(void) : QueryClient(kb(16)) {}
	QueryClient(int QueryBufferSize);
	~QueryClient(void);
...
#endif // GAMESERVER_QUERY_CLIENT_H
